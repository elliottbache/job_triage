...
def _create_user_message(
    ...
    return (
        ...
        - **Skill Priority**: Assign a priority level to each skill from JobPostExtraction based on the "order_of_appearance", "priority_signal", "required_level", and "required_years". If required_years is null, use the remaining signals to determine the priority. Return `skill_priority` as a list of objects, one per extracted skill, where each object has:
