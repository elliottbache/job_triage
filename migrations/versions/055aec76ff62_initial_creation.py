...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["raw_job_id"],
            ["raw_jobs.id"],
            name=op.f("fk_job_assessment_raw_job_id_raw_jobs"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_job_assessment")),
        sa.UniqueConstraint("raw_job_id", name=op.f("uq_job_assessment_raw_job_id")),
    )
